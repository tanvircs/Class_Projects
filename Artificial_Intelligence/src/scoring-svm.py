"""Multi-label classification using support vecotr machine algorithm and calculate Micro-F1 and Macro-F1 values."""
...
def main():
    parser = ArgumentParser("scoring-svm",
    ...
    for train_percent in training_percents:
        for shuf in shuffles:
            ...
            subclf = SVC(gamma='auto', probability=True)
